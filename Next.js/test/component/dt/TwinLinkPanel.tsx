    ...
    <div style={panel}>
      ...
      {!isLinkSelectMode ? (
        <>
          {selectedSectionId && (
            <button
              style={{ ...btnBase, width: "100%", marginBottom: "8px", background: "rgba(56,189,248,0.15)", color: "#38bdf8", border: "1px solid rgba(56,189,248,0.3)" }}
          ...
          {linkData.length === 0 ? (
            <p style={{ color: "#4b5160", fontSize: "12px", textAlign: "center", padding: "8px 0" }}>
        ...
        <>
          ...
          {newCount > 0 && (
            <p style={{ color: "#4ade80", fontSize: "11px", marginBottom: "8px" }}>새 링크 {newCount}개 추가 예정</p>
          )}
